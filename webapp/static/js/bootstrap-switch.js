            ...
            init: function() {
                return this.each(function() {
                    ...
                    $label = $('<label>')
                        .html(" ")
                        .addClass(myClasses)
                        .attr('for', $element.find('input')
                        .attr('id'));

                    $div = $element.find(':checkbox')
                        .wrap($('<div>'))
                        .parent()
                        .data('animated', false);

                    if ($element.data('animated') !== false) $div.addClass('switch-animate')
                        .data('animated', true);
                    ...
                    $element.find('>div')
                        .addClass(
                    $element.find('input')
                        .is(':checked') ? 'switch-on' : 'switch-off');
                    ...
                    $element.find('input')
                        ...
                        if ($(this)
                            .is(':checked')) $element.removeClass('switch-off')
                            .addClass('switch-on');
                    ...
                    $element.find('label')
                        ...
                        $this.closest('div')
                            .removeClass('switch-animate');

                        if ($this.closest('.switch')
                            .is('.deactivate')) $this.unbind('click');
                        else {
                            ...
                            $this.on('click touchend', function(e) {
                                ...
                                if (moving) $myCheckBox.prop('checked', !(parseInt($this.parent()
                                    .css('left')) < -25));
                            ...
                            $this.on('mouseleave', function(e) {
                                ...
                                $myCheckBox.prop('checked', !(parseInt($this.parent()
                                    .css('left')) < -25))
                                    .trigger('change');
                            });
